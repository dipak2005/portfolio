...
List<ProjectUtil> projectUtilList = [
  ProjectUtil(
    ...
    banners: "assets/images/chat.png",
  ),
  ProjectUtil(
    description:
  ...
  ProjectUtil(
    ...
    banners: "assets/images/expense.png",
  ),
  ProjectUtil(
    description:
  ...
  ProjectUtil(
    description:
        "This is Bhagavat-Geeta  by Using Flutter ,Source Code is also available ,check now.",
    title: " Awesome Geeta App ",
    icons: "assets/images/flutter.png",
    link: "https://github.com/dipak2005/Bhagvat_Geeta",
    banners: "assets/images/gita.png",
  ),
];
